...
- `siteTitle` - Website title shown in the browser tab
- `siteDescription` - Meta description for SEO
- `accentColor` - Primary accent color as hex value (e.g. `#3B82F6`)
- `themeMode` - `"light"` | `"dark"` | `"dynamic"` (system preference)
- `maxWidth` - `"xl"` (1280px) | `"l"` (1024px) | `"m"` (768px) | `"s"` (640px)
- `fontFamily` - CSS font-family value (e.g. `"Georgia, serif"`)
- `navbarAligned` - `"center"` | `"right"` (logo left, nav right)
- `navbarLogo` - Path to logo image or text
